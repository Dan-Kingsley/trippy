module ApplicationHelper
  ...
  def photo_thumb_tag(photo, size: 64, css_class: "")
    ...
    img = image_tag photo.video? ? photo.image.preview(resize_to_limit: [ size, size ]) : photo.image.variant(resize_to_fill: [ size, size ], saver: { quality: 80 }, loader: { fail_on: :none }),
