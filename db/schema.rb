...
ActiveRecord::Schema[8.1].define(version: 2026_09_01_120000) do
  ...
  create_table "trip_entry_reads", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.integer "trip_entry_id", null: false
    t.datetime "updated_at", null: false
    t.integer "user_id", null: false
    t.index ["trip_entry_id", "user_id"], name: "index_trip_entry_reads_on_trip_entry_id_and_user_id", unique: true
    t.index ["trip_entry_id"], name: "index_trip_entry_reads_on_trip_entry_id"
    t.index ["user_id"], name: "index_trip_entry_reads_on_user_id"
  end
  ...
  add_foreign_key "trip_entry_reads", "trip_entries"
  add_foreign_key "trip_entry_reads", "users"
